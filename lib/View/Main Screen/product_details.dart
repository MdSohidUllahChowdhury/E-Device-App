      ...
      body: Container(
        ...
        Column(
          ...
          children: [
            ...
            ).animate(autoPlay: true,delay: const Duration(seconds: 2)).shimmer(curve: const Split(BorderSide.strokeAlignCenter),duration: const Duration(seconds: 3)),
            ...
            const Divider(height: 25,color: Colors.white,thickness: 13,),
            const Divider(color: Colors.redAccent,thickness: 13,),
            const Text(
